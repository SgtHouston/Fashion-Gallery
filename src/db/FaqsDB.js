const FaqsDB = [
    {
        ...
        Answer: 'SLR Couture is located in the United States in Atlanta, GA'
    },
    {
        Question: 'DO YOU HAVE A STOREFRONT?',
        Answer: 'We do not have a storefront at this time as we are an exclusively online company. We do have an office in Georgia, but this location is not set up for customer visits. Items can be picked up with pre-approval.'
    },
    {
    ...
    {
        Question: 'IS THERE A CONSULTATION A FEE?',
        Answer: 'BRIDAL CONSULTATION $150 - 2hrs \n PROM CONSULTATION $75 - 1hr \n CUSTOM CONSULTATION $50 - 30min'
    },
    {
        Question: 'HOW LONG DOES THE COUTURE PROCESS TAKE?',
        Answer: 'BRIDAL TURNAROUND TIMEFRAME 24-48 WEEKS \n PROM TURNAROUND TIMEFRAME 4-6 WEEKS \n CUSTOM TURNAROUND TIMEFRAME 2-4 WEEKS \n '
    },
    {
        Question: 'HOW SOON CAN I BEGIN THE COUTURE PROCESS FOR MY GOWN?',
        Answer: 'We advise beginning the process at least 24 weeks to your wedding. We do offer express couture services. Please send an e-mail to slrcouture@gmail.com if you need a gown less than 24 weeks to your wedding.'
    },
    {
        Question: 'DO YOU OFFER RUSH ORDERS?',
        Answer: 'We can provide rush orders with lead times under 12 weeks contingent upon on our production schedule. All rush orders must be requested prior to ordering. All orders are shipped via UPS Standard Ground (7-10 business days) unless otherwise requested. Rush orders are subject to prior approval. This option does not include shipping, which you will be billed separately.'
    },
    {
        Question: 'DO YOU OFFER COUTURE TO BRIDES INTERNATIONALLY?',
        Answer: 'Yes, we do extend our couture services to international brides. Consultations will be held virtually via a video call, during which we will walk you through the entire couture process in detail.'
    },
    {
        Question: 'HOW SOON CAN I BEGIN THE COUTURE PROCESS FOR MY GOWN?',
        Answer: 'We advise beginning the process at least 24 weeks to your wedding. We do offer express couture services. Please send an e-mail to slrcouture@gmail.com if you need a gown less than 24 weeks to your wedding.'
