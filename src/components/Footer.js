    ...
    return (
        ...
        <nav className="navbar navbar-dark text-center">
            ...
            <div className="footer-contact">
                ...
                <a className="footer-info" title="Follow Us On TikTok!" href="https://www.tiktok.com/@slr.couture?_t=8qdODI2LS5D&_r=1" ><span ><TikTokIcon color="#545B5A" /> @slr.couture </span></a><br/>
